...
const main = async (event = {}) => {
  ...
  const handlers = { listCategories, listAccounts, listMembers, getBillPreferences, saveBillPreferences, createBill, listBills, getStats };
  const handler = handlers[action];
  if (!handler) return { ...fail("未知操作", "UNKNOWN_ACTION"), buildVersion: BUILD_VERSION, receivedType: action, receivedTypeLength: action.length };
